         ...
         <div class="container">
            <div class="row">
               <div class="col-md-12 text-center">
                  <h1 class="mt-0 mb-3 text-white">Rentkeya品质管家</h1>
                  <div class="breadcrumbs">
                     <p class="mb-0 text-white"><a class="text-white" href="#">贴心文职工作 分发邮件 接电话 帮助Rentkeya专业物业经理处理力所能及租房相关的事</p>
                  </div>
               </div>
            </div>
         </div>
               ...
               <div class="col-lg-4 col-md-4">
                  <div class="card padding-card">
                     <div class="card-body agents-card text-center">
                        ...
                        <p class="mb-4">感谢您选择Rentkeya ，我一定会用我200%的认真和仔细，和专业度回报这份信任，有任何咨询 欢迎电话 邮件联系我</p>
                        <h6 class="mb-0 text-success">- Rentkeya租房管家</h6>
                        <small>info@rentkeya.ca</small>
                     </div>
                  </div>
