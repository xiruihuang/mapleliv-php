        ...
        <section class="aui-flexView">
            ...
            <section class="aui-scrollView">
                <div class="aui-palace">
                    ...
                    <a href="/generalProperty" class="aui-palace-grid">
                        <div class="aui-palace-grid-icon">
                    ...
                    <a href="/mobileTeam" class="aui-palace-grid">
                        <div class="aui-palace-grid-icon">
                            <img src="../mobile2/images/icon-item-009.png" alt="">
                        </div>
                        <div class="aui-palace-grid-text">
                            <h2>品质管家</h2>
                        </div>
