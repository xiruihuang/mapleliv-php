         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-4 col-md-4">
                  ...
                  <h6 class="text-dark"><i class="mdi mdi-phone"></i> Phone Number :</h6>
                  <p>(+1)604-336-9608</p>
                  <h6 class="text-dark"><i class="mdi mdi-deskphone"></i> Wechat Service :</h6>
                  <p>whatsupissac</p>
                  <h6 class="text-dark"><i class="mdi mdi-email"></i> Email :</h6>
                  <p>info@rentkeya.ca</p>
                  <h6 class="text-dark"><i class="mdi mdi-link"></i> Official Account :</h6>
                  <p>rentkeya</p>
            ...
            <div class="row">
               ...
               <form class="col-lg-12 col-md-12" action="/sentMessage" method="POST">
                  {{ csrf_field() }}
                     ...
                     <div class="control-group form-group">
                        <div class="controls">
                     <label>what to tell us<span class="text-danger">*</span></label>
