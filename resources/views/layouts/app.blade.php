...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
    ...
    <div id="header" class="header navbar-default">
        ...
        <div class="navbar-header">
            <a href="/" class="navbar-brand"><span class="navbar-logo"></span> <b>枫窝 |</b> MapleLiving</a>
                ...
                @if(Auth::user()->type < 2)
                    <li class="has-sub">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="/createTypes">Create User Type<i
                    ...
                    <li class="has-sub">
                        ...
                        <ul class="sub-menu">
                            <li><a href="/createRenter">添加租客记录<i class="fa fa-paper-plane text-theme m-l-5"></i></a>
                            </li>
