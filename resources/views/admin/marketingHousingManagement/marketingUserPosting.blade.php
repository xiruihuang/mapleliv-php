...
@include('sweet::alert')
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active"><a href="/marketingUserPosting">我的发布</a></li>
				
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Rentkeya市场部房源 <small>我的发布</small></h1>
			<!-- end page-header -->
                                ...
                                <tbody>
                                    ...
                                    <tr class="gradeA">
                                        ...
                                        <td>
                                        	...
                                        	<a href="/editMarketingPosting/{{$u -> id}}"><button class="btn btn-primary">修改信息</button></a>
                                        	<a href="/modifiedPictures/{{$u -> id}}"><button class="btn btn-info">修改图片</button></a>
                                        	@elseif($u -> status == 1)
