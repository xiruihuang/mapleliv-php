...
@section('content')
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
              ...
              <div style="margin-top:69px;height:685px">
                ...
                <img src="{{$a -> ad_image_url}}/{{$a->ad_name}}.gif" alt="{{$a -> ad_name}}" style="padding:18px;height:25%;width:100%">
                @endif
                @endforeach
      ...
      @else
            ...
            <section style="padding-bottom:30px;padding-top: 18px">
         <div class="container">
            <div class="row">
               <div class="col-lg-8 col-md-8">
                  <div class="card">
...
<!--                                   @endforeach-->
  ...
  @endif
      ...
      <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAltTj_A57PS6Apt9aVIGm73MRZ5g4NDHU&callback=initMap"></script>
      @endsection
   </body>
</html>
