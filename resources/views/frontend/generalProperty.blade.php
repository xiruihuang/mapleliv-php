         ...
         <div class="container">
            <div class="row">
               <div class="col-md-12 text-center">
                ...
                <a href="/">
                  <h1 class="mt-0 mb-3 text-white">大众房源</h1>
                  <div class="breadcrumbs">
                     <p class="mb-0 text-white"><a class="text-white" href="#">整合大温地区精品房源</p>
                     </a>
                  </div>
               </div>
            </div>
                  ...
                  <div class="row no-gutters">
                     ...
                     <div class="col-md-3">
                        <div class="input-group">
                           ...
                           <input class="form-control" name="minPrice"   placeholder="最低价格" type="text">
                     ...
                     <div class="col-md-3">
                        <div class="input-group">
                           ...
                           <input class="form-control" name="maxPrice"  placeholder="最高价格" type="text">
                        </div>
                     </div>
                      ...
                      <div class=" row">
                         <div class="col-lg-6 col-md-6 tags-action">
                          ...
                          <span style="background-color: #7DCEA0; font:italic bold 12px/20px arial,sans-serif; color: white;">城市: <?php echo $filterResult['filterCity'] ?>
                           <?php $urlCity="/generalProperty?city=&minPrice=".$filterResult['filterMinPrice']."&maxPrice=".$filterResult['filterMaxPrice']?>
