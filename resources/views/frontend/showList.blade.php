...
@if($agent->isDesktop())
                  ...
                  <ul class="navbar-nav mr-auto mt-2 mt-lg-0 margin-auto">
                     ...
                     <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownPortfolio">
                           <a class="dropdown-item" href="/aboutUs">关于 Rentkeya</a>
                           <!--
                     ...
                     <ul class="list-inline main-nav-right">
                        @if(Auth::Check())
                            @if(Auth::user()->type == 1)
                                ...
                                <li class="list-inline-item">
                                   <a class="btn btn-success btn-sm" href="/addGenProperty">发布房源</a>
                                </li>
                            @endif
                            ...
                            @if(Auth::user() ->type > 1)
                                ...
                                <li class="list-inline-item">
                                   <a class="btn btn-success btn-sm" href="/showList">我的发布</a>
                                </li>
                                <li class="list-inline-item">
                                   <a class="btn btn-success btn-sm" href="/addGenProperty">免费发布房源</a>
                                </li>
                            @endif
            ...
            <div class="row">
               <div class="col-md-12 text-center">
                @if($agent->isDesktop())
                  ...
                  <h1 class="mt-0 mb-3 text-white">我的发布</h1>
                  <div class="breadcrumbs">
                     <p class="mb-0 text-white"><a class="text-white" href="#">Rentkeya保证品质，安心租房</p>
                @else
                    <h1 class="mt-0 mb-3 text-white" style="font-size: 60px">我的发布</h1>
                  <div class="breadcrumbs">
                     <p class="mb-0 text-white" style="font-size: 32px"><a class="text-white" href="#">Rentkeya保证品质，安心租房</p>
                @endif
                  </div>
               </div>
            </div>
                  ...
                  <div class="osahan_top_filter row">
                     ...
                     <div class="col-lg-12 col-md-12 sort-by-btn float-right">
                      ...
                      -->
                        ...
                        <div class="dropdown float-right">
                          <a class="btn btn-success" href="/" style="font-size: 25px"> 返回首页</a>
                          <a class="btn btn-success" href="/login" style="font-size: 25px">登录</a>
                          <!--
                     ...
                     <div class="col-lg-12 col-md-12">
                        ...
                        <div class="card card-list card-list-view">
                           ...
                           <a href="/edit/{{$h -> id}}">
                            ...
                            <div class="row">
                              <div class="col-md-2">
                              <a href="/refresh/{{$h->id}}"><button class="btn btn-success"> 刷新</button></a>
                              </div>
                                <div class="col-md-2">
                                    <a href="/photoControl/{{$h->id}}"><button class="btn btn-warning"> 改图</button></a>
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <button class="btn btn-grey">已移除</button>
                                    @else
                                    <a href="/userdelete/{{$h->id}}"><button class="btn btn-warning"> 移除</button></a>
                                    @endif
                                </div>
      ...
      <section class="section-padding bg-dark text-center">
         ...
         <p class="text-white mb-4">详情请联系Rentkeya客服，我们期待你的加入</p>
      ...
      @else
            <section class="section-padding bg-dark text-center">
         <h2 class="text-white mt-0" style="font-size: 48px">加入Rentkeya | 安家</h2>
         <p class="text-white mb-4" style="font-size: 32px">详情请联系Rentkeya客服，我们期待你的加入</p>
         <button type="button" class="btn btn-success" style="font-size: 30px color: white"><a href="/contactUs"> 联系我们</a></button> <button type="button" class="btn btn-outline-success" style="font-size: 30px color: white"><a href="/aboutUs"> 更多详情</a></button>
      </section>
      @endif
      <!-- End Join Team -->
   <!-- Footer -->
         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-4 col-md-3">
                  <h4 class="mb-5"><a class="text-success logo" href="index.html"><i class="mdi mdi-home-map-marker"></i> <strong>Rentkeya | </strong>安家</a></h4>
