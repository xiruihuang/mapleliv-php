         ...
         <div class="container">
            <div class="row">
               <div class="col-md-12 text-center">
                  <h1 class="mt-0 mb-3 text-white">修改房源</h1>
            ...
            <div class="row">
               <div class="col-lg-12">
                  <ul class="nav justify-content-center">
                     ...
                     <li class="nav-item">
                        <a class="nav-link text-link active text-success">修改房源</a>
                     </li>
               ...
               <div class="col-lg-8 col-md-8 mx-auto">
                  <form method="POST" action="/editRentkeyaHousing/{{$housing -> id}}" enctype="multipart/form-data">
                     ...
                     <div class="card padding-card">
                        <div class="card-body">
                           <h5 class="card-title mb-4">房屋信息 <small style="color: red">(请检查所有的栏目再提交)</small></h5>
                           <div class="form-group">
                              <label>标题<span class="text-danger">*</span></label>
                              <input type="text" name="title" value="{{$housing -> title}}" class="form-control" placeholder="请输入文字描述" required>
                           </div>
                           <div class="form-group">
                              <label>联系人<span class="text-danger">*</span></label>
                              <input type="text" name="contactPeople" value="{{$housing -> contactPeople}}" class="form-control" placeholder="请输入联系人姓名" required>
                           </div>
                           <div class="form-group">
                              <label>电话<span class="text-danger">*</span></label>
                              <input type="text" name="phone" value="{{$housing -> phone}}" class="form-control" placeholder="请输入联系人电话" required>
                           </div>
                           <div class="form-group">
                              <label>微信</label>
                              <input type="text" name="wechat" class="form-control" value="{{$housing -> wechat}}" placeholder="请输入联系人微信">
                           </div>
                           
                           <div class="row">
                              <div class="form-group col-md-4">
                                    <label>地址<span class="text-danger">*</span></label>
                                    <input type="text" name="address" class="form-control" value="{{$housing -> address}}" placeholder="请输入地址">
                               </div>
                               <div class="form-group col-md-4">
                                    <label>城市<span class="text-danger">*</span></label>
                                    <input type="text" name="city" class="form-control" value="{{$housing -> city}}" placeholder="请输入城市名称">
                               </div>
                               <div class="form-group col-md-4">
                                    <label>区域</label>
                                    <input type="text" name="area" value="{{$housing -> area}}"  class="form-control" placeholder="请输入城市名称">
                               </div>
                               <div class="form-group col-md-4">
                                    <label>收入价格<span class="text-danger">*</span></label>
                                    <input type="number" name="originPrice" value="{{$housing -> originPrice}}" class="form-control" placeholder=" 请输入数字,单位 $/month">
                               </div>
                               <div class="form-group col-md-4">
                                    <label>公布价格<span class="text-danger">*</span></label>
                                    <input type="number" name="publicPrice" value="{{$housing -> publicPrice}}" class="form-control" placeholder=" 请输入数字,单位 $/month">
                               </div>
                           </div>
                  ...
                  <form method="POST" action="/editGenProperty/{{$housing -> id}}" enctype="multipart/form-data">
                     ...
                     <div class="card padding-card">
                        <div class="card-body">
                           ...
                           <div class="form-group">
                              <label>标题<span class="text-danger">*</span></label>
                              <input type="text" name="title" class="form-control" value="{{$housing -> title}}" placeholder="请输入文字描述" required>
                           </div>
                           <div class="form-group">
                           ...
                           <div class="row">
                              <div class="form-group col-md-4">
                               ...
                               <div class="form-group col-md-4">
                                    <label>城市<span class="text-danger">*</span></label>
                                    <input type="text" name="city" class="form-control" value="{{$housing -> city}}" placeholder="请输入城市名称" required>
                               </div>
                               <div class="form-group col-md-4">
                                    <label>价格<span class="text-danger">*</span></label>
                                    <input type="number" name="publicPrice" class="form-control" value="{{$housing -> publicPrice}}" placeholder=" 请输入数字,单位 $/month" required>
                               </div>
                           </div>
